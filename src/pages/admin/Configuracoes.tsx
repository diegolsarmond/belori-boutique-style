...
import { Save, CreditCard, CheckCircle, AlertCircle, Info } from "lucide-react";
              ...
              <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                <div className="flex gap-2">
                  ...
                  <div className="text-sm text-blue-700 dark:text-blue-300">
                    <p className="font-medium mb-1">Configuração híbrida</p>
                    <p className="text-blue-600 dark:text-blue-400">
                      Em <strong>produção</strong>, as credenciais são lidas das variáveis de ambiente (.env).
                      Em <strong>desenvolvimento local</strong>, use esta configuração abaixo como fallback.
                    </p>
                  </div>
                </div>
              </div>
